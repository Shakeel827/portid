...
const Browse: React.FC = () => {
  ...
  const profiles = [
    ...
    },
    {
      ...
      urlName: "devops",
      image: greyImage,
      backgroundGif: "https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExNGNidDl5emZpejY2eGFxa2I4NW0zZGNpbWRlbnBrZ3N2dWhhbzM1MyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/TFPdmm3rdzeZk0P3zG/giphy.gif" // Flickering neon lights
    },
    {
      name: "AI Website Developer",
      displayName: "AI Website Developer",
      urlName: "ai-website-developer",
      image: redImage,
  ...
  const handleProfileClick = (profile: { name: string; urlName: string; image: string; backgroundGif: string }) => {
    navigate(`/profile/${profile.urlName}`, { state: { profileImage: profile.image, backgroundGif: profile.backgroundGif, profileName: profile.name } });
  };
